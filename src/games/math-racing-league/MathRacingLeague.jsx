...
import { ArrowLeft, ArrowRight, Gem, Pause, Play, Star, Trophy, WalletCards } from "lucide-react";
  ...
  if (!selectedLeagueId) {
    return (
      <section className="mrl-menu">
        <nav className="mrl-flow-nav" aria-label="Math Racing League navigation">
          <button type="button" onClick={onBackToHub}>
            <ArrowLeft size={18} /> Games
          </button>
          <strong>Pick League</strong>
